...
# Part 2
part2 = solve2(list(map(parse, open('vis/day18.txt').readlines())))
print(part2)
...
#     pcs = [0, 0]
#     idx = 0 # running program
#     currentPC = 0 # need it to compare at the end because of switching
#     messages = [deque([]), deque([])]
#     regs[1]['p'] = 1
#     states = ['running', 'running']
#     count = 0
